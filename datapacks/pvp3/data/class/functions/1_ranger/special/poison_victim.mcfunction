# 标记受害者
execute if entity @s[tag=level1] as @e[distance=..4.6,type=#modules:living] positioned ~-5 ~ ~-5 as @s[dx=10,dy=0.5,dz=10] run tag @s add poison_victim
execute if entity @s[tag=level2] as @e[distance=..4.2,type=#modules:living] positioned ~-5 ~ ~-5 as @s[dx=10,dy=0.5,dz=10] run tag @s add poison_victim
execute if entity @s[tag=level3] as @e[distance=..3.8,type=#modules:living] positioned ~-5 ~ ~-5 as @s[dx=10,dy=0.5,dz=10] run tag @s add poison_victim
execute if entity @s[tag=level4] as @e[distance=..3.4,type=#modules:living] positioned ~-5 ~ ~-5 as @s[dx=10,dy=0.5,dz=10] run tag @s add poison_victim
# 给予效果
tag @s add self
