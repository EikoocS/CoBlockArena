# 成就
execute if entity @s[x=1000,y=80,z=1072,dx=100,dy=100,dz=100] if entity @a[tag=projectile_owner,x=1000,y=92,z=1000,dx=100,dy=100,dz=47] run advancement grant @a[tag=projectile_owner] only pvp:hidden/teleport_arrow
