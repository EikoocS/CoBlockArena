...
scoreboard players operation @s count1 = @s 1_st11
scoreboard players operation @s cd1 = @s 1_cd11

# 凋亡箭
item replace entity @s[scores={1_st21=1..},nbt=!{Inventory:[{Slot:1b,tag:{CustomModelData:102}}]}] hotbar.1 with tipped_arrow{CustomModelData:102,CustomPotionEffects:[{Id:20b,Amplifier:1,Duration:405,ShowParticles:true}],CustomPotionColor:7812416}
scoreboard players operation @s count2 = @s 1_st21
scoreboard players operation @s cd2 = @s 1_cd21

# 巫毒箭
item replace entity @s[scores={1_st31=1..},nbt=!{Inventory:[{Slot:2b,tag:{CustomModelData:103}}]}] hotbar.2 with tipped_arrow{CustomModelData:103,CustomPotionColor:5739047}
scoreboard players operation @s count3 = @s 1_st31
scoreboard players operation @s cd3 = @s 1_cd31

# 光焰箭
item replace entity @s[scores={1_st41=1..},nbt=!{Inventory:[{Slot:3b,tag:{CustomModelData:104}}]}] hotbar.3 with tipped_arrow{CustomModelData:104,CustomPotionEffects:[{Id:24b,Amplifier:0,Duration:400,ShowParticles:true},{Id:18b,Amplifier:0,Duration:400,ShowParticles:true}],CustomPotionColor:16752969}
scoreboard players operation @s count4 = @s 1_st41
scoreboard players operation @s cd4 = @s 1_cd41

# 折跃箭
item replace entity @s[scores={1_st51=1..},nbt=!{Inventory:[{Slot:4b,tag:{CustomModelData:105}}]}] hotbar.4 with tipped_arrow{CustomModelData:105,CustomPotionColor:1275237}
scoreboard players operation @s count5 = @s 1_st51
scoreboard players operation @s cd5 = @s 1_cd51
...
# 护甲
execute if score $info_refresh_inv debug matches 1 if entity @s[tag=!invisible,nbt=!{Inventory:[{Slot:103b,tag:{CustomModelData:120}}]}] run playsound minecraft:item.armor.equip_iron player @s ~ ~ ~ 1 1
