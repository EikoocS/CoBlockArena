...
# 设置触发者信息
execute if entity @s[team=red] run scoreboard players operation @e[tag=new_minion] player_id_sub = @p[team=!red] player_id
execute if entity @s[team=blue] run scoreboard players operation @e[tag=new_minion] player_id_sub = @p[team=!blue] player_id
execute if entity @s[team=green] run scoreboard players operation @e[tag=new_minion] player_id_sub = @p[team=!green] player_id
execute if entity @s[team=yellow] run scoreboard players operation @e[tag=new_minion] player_id_sub = @p[team=!yellow] player_id
