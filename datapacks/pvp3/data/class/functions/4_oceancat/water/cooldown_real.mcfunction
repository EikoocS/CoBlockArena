...
# 冷却完成
scoreboard players add @s[scores={4_water_cd=..0}] 4_water_storage 1
scoreboard players add @s[scores={4_water_cd=..0,4_water_storage=..1}] 4_water_cd 30000
scoreboard players set @s[scores={4_water_cd=..0,4_water_storage=2..}] 4_water_cd 30000

# 检测刷新
tag @s[scores={4_water_cd=..3099,4_water_storage=0}] add refresh_inventory
