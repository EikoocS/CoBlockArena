...
attribute @s minecraft:generic.knockback_resistance modifier add 123-0-0-3-101 "" 100 add
...
playsound minecraft:entity.zombie.attack_iron_door player @s 0 1000000 0 200000 0
playsound minecraft:entity.zombie.attack_iron_door player @a[distance=0.1..] ~ ~ ~ 1 0
playsound minecraft:block.beacon.activate player @s 0 1000000 0 1000000 1.1
playsound minecraft:block.beacon.activate player @s 0 1000000 0 1000000 1.1
