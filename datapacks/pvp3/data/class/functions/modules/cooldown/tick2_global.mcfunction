...
# 应用厄难之血
execute if score $mutation mem matches 4 run scoreboard players set @a cd_speed 0
# 复活与训练场加速
...
# 应用潮涌能量
#scoreboard players add @a[nbt={ActiveEffects:[{Id:29b,Amplifier:0b}]}] cd_speed 25
#scoreboard players add @a[nbt={ActiveEffects:[{Id:29b,Amplifier:1b}]}] cd_speed 67