...
# 灿焰长剑
item replace entity @s[scores={statPlayerLevel=1},nbt=!{Inventory:[{Slot:0b,tag:{CustomModelData:501}}]}] hotbar.0 with golden_sword{CustomModelData:501,AttributeModifiers:[{UUID:[I;3,0,1,1],Amount:5,AttributeName:"generic.attack_damage",Name:"attack",Slot:"mainhand",Operation:0},{Operation: 0, Amount: -2.25, UUID: [I;3,0,1,2], AttributeName: "generic.attack_speed", Name: "generic.attackSpeed"}],Unbreakable:1b,HideFlags:63,Enchantments:[{id:"minecraft:fire_aspect",lvl:1}]}
item replace entity @s[scores={statPlayerLevel=2},nbt=!{Inventory:[{Slot:0b,tag:{CustomModelData:501}}]}] hotbar.0 with golden_sword{CustomModelData:501,AttributeModifiers:[{UUID:[I;3,0,1,1],Amount:5,AttributeName:"generic.attack_damage",Name:"attack",Slot:"mainhand",Operation:0},{Operation: 0, Amount: -2.4, UUID: [I;3,0,1,2], AttributeName: "generic.attack_speed", Name: "generic.attackSpeed"}],Unbreakable:1b,HideFlags:63,Enchantments:[{id:"minecraft:fire_aspect",lvl:1}]}
item replace entity @s[scores={statPlayerLevel=3},nbt=!{Inventory:[{Slot:0b,tag:{CustomModelData:501}}]}] hotbar.0 with golden_sword{CustomModelData:501,AttributeModifiers:[{UUID:[I;3,0,1,1],Amount:5,AttributeName:"generic.attack_damage",Name:"attack",Slot:"mainhand",Operation:0},{Operation: 0, Amount: -2.5, UUID: [I;3,0,1,2], AttributeName: "generic.attack_speed", Name: "generic.attackSpeed"}],Unbreakable:1b,HideFlags:63,Enchantments:[{id:"minecraft:fire_aspect",lvl:1}]}
item replace entity @s[scores={statPlayerLevel=4},nbt=!{Inventory:[{Slot:0b,tag:{CustomModelData:501}}]}] hotbar.0 with golden_sword{CustomModelData:501,AttributeModifiers:[{UUID:[I;3,0,1,1],Amount:5,AttributeName:"generic.attack_damage",Name:"attack",Slot:"mainhand",Operation:0},{Operation: 0, Amount: -2.65, UUID: [I;3,0,1,2], AttributeName: "generic.attack_speed", Name: "generic.attackSpeed"}],Unbreakable:1b,HideFlags:63,Enchantments:[{id:"minecraft:fire_aspect",lvl:1}]}
...
# 护甲
execute if score $info_refresh_inv debug matches 1 if entity @s[tag=!invisible,nbt=!{Inventory:[{Slot:103b,tag:{CustomModelData:520}}]}] run playsound minecraft:item.armor.equip_iron player @s ~ ~ ~ 1 1
...
item replace entity @s[tag=!invisible,nbt=!{Inventory:[{Slot:102b,tag:{CustomModelData:521}}]}] armor.chest with iron_chestplate{CustomModelData:521,Unbreakable:1b,display:{Name:'{"text":"塑料板甲","italic": false,"color":"white"}',Lore:['{"text":"看似很结实，但其实是塑料制品。","italic": false,"color":"gray"}','""','[{"text":"❤ 生命  ","italic": false,"color":"red"},{"text":"+ 4","italic": false,"color":"white"}]']},AttributeModifiers:[],HideFlags:1023,NeedColor:0b,Trim:{material:"minecraft:gold",pattern:"minecraft:dune"}}
