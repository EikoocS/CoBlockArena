...
execute if score $is_day mem matches 1 run scoreboard players set @a[tag=current_ray_owner] 5_star_cd 8000
execute if score $is_day mem matches 0 run scoreboard players set @a[tag=current_ray_owner] 5_star_cd 16000
