...
execute if score $is_day mem matches 1 run scoreboard players set @s[scores={5_star_cd=..0}] 5_star_cd 8000
execute if score $is_day mem matches 0 run scoreboard players set @s[scores={5_star_cd=..0}] 5_star_cd 16000
