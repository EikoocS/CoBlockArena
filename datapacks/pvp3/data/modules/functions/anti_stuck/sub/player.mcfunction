...
execute if score $track_ray_tp debug matches 1 at @s run particle minecraft:block_marker red_wool ~0.05 ~0.45 ~0.05
...
execute if score $track_ray_tp debug matches 1 at @s run particle minecraft:block_marker green_wool ~-0.05 ~0.35 ~-0.05