# 触发疾跑提示
tag @a[scores={state=2..,tip_run=..3000,tip_walk=10000..}] add tip_2_run
...
# 新手引导
execute as @a[scores={tip_0_tutorial=..8,tip_cd=11..}] if entity @s[tag=!tip_1_respawn_class,tag=!tip_1_train,tag=!tip_1_afk,tag=!tip_1_regen,tag=!tip_1_waterkill,tag=!tip_1_regen_effect] run function modules:tip/0_tutorial
# 延迟显示的提示
