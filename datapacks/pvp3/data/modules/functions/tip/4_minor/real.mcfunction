...
scoreboard players set @s[scores={tip_minor_head=13}] tip_minor_head 1

# 显示提示
tellraw @s[scores={tip_minor_head=1}] ["",{"text":"\n ⚜  小知识： ","color":"light_purple"},"服务器管理员可以通过 /function debug 打开控制面板！\n"]
tellraw @s[scores={tip_minor_head=2}] ["",{"text":"\n ⚜  小知识： ","color":"light_purple"},"如果你从来不看小知识，那你也就不会看到这句话了！\n"]
