...
execute as @s[scores={temp=-10..,fall_last=..-65,state=2..3},type=player,gamemode=adventure] at @s run playsound minecraft:entity.player.small_fall player @a ~ ~ ~ 1 1.1
