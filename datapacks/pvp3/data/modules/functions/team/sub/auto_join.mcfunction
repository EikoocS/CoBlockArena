...
execute if entity @s[tag=red] run scoreboard players operation #min mem < §c红队§r teamKill
execute if entity @s[tag=blue] run scoreboard players operation #min mem < §9蓝队§r teamKill
execute if entity @s[tag=green] run scoreboard players operation #min mem < §a绿队§r teamKill
execute if entity @s[tag=yellow] run scoreboard players operation #min mem < §e黄队§r teamKill
# 加入目前最差的队伍
execute if score §c红队§r teamKill = #min mem if entity @s[tag=red] run team join red @s
execute if score §9蓝队§r teamKill = #min mem if entity @s[tag=blue] run team join blue @s
execute if score §a绿队§r teamKill = #min mem if entity @s[tag=green] run team join green @s
execute if score §e黄队§r teamKill = #min mem if entity @s[tag=yellow] run team join yellow @s
