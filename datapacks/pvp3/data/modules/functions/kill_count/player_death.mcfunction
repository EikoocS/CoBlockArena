...
execute if entity @a[tag=murder,team=red] if entity @s[team=red] run scoreboard players set #death_type mem 1
execute if entity @a[tag=murder,team=blue] if entity @s[team=blue] run scoreboard players set #death_type mem 1
execute if entity @a[tag=murder,team=green] if entity @s[team=green] run scoreboard players set #death_type mem 1
execute if entity @a[tag=murder,team=yellow] if entity @s[team=yellow] run scoreboard players set #death_type mem 1
