...
# 提示
execute if score #mutation mem matches 9200.. if score $mutation_warn mem matches 0 run playsound minecraft:block.note_block.chime player @a 0 1000000 0 1000000 0.7
execute if score #mutation mem matches 9200.. if score $mutation_warn mem matches 0 run title @a[scores={state=2}] actionbar {"color":"gold","text":"⚠ 突变效果即将触发","bold": true}
...
# 触发
execute if score #mutation mem matches 10000.. if score $mutation mem matches 2 as @a[scores={state=2}] at @s run function modules:mutation/special/2_trigger
execute if score #mutation mem matches 10000.. if score $mutation mem matches 6 run function modules:mutation/special/6_trigger
