...
tag @a[tag=!brRegenBreak,scores={brRegenSneak=6..,state=2..}] add brRegenCheck
...
tag @a[nbt={ActiveEffects:[{Id:31b}]}] add bad_omen
...
execute as @a[scores={state=2..,mino_forgive_timer=1,hp=..12,brRegen=5,tip_1_regen=..1},nbt=!{ActiveEffects:[{Id:31b}]}] run tag @s add tip_1_regen
execute as @a[scores={state=2..,mino_forgive_timer=-40,hp=..12,brRegen=5,tip_1_regen=..10}] run tag @s add tip_1_regen
